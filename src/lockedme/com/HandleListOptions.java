package lockedme.com;
	import java.util.List;
		...
		public class HandleListOptions {
			public static void handleWelcomeScreenInput() {
				boolean running = true;
				Scanner sc = new Scanner(System.in);
				do {
					try {
						MenuListOptions.displayMenuList();
						...
						case 1:
							...
							break;
						case 2:
							HandleListOptions.handleFileListOptions();
							break;
			...
			public static void handleFileListOptions() {
				
				boolean running = true;
				Scanner sc = new Scanner(System.in);
				do {
					try {
						MenuListOptions.displayFileMenuListOptions();
